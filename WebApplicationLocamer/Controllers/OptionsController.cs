...
namespace WebApplicationLocamer.Controllers
{
    public class OptionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_Option,libelle_Option,prix_Option")] Option option)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_Option,libelle_Option,prix_Option")] Option option)
        {
            if (ModelState.IsValid)
            {
